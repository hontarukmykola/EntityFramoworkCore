...
namespace MusicСollection.Migrations
{
    ...
    [Migration("20240302175659_MusicCollection")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicСollection.Album", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicСollection.Artist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicСollection.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicСollection.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicСollection.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicСollection.Playlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicСollection.Track", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlbumTrack", b =>
                {
                    b.HasOne("MusicСollection.Album", null)
                        .WithMany()
                        .HasForeignKey("AlbumsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicСollection.Track", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicСollection.Album", b =>
                {
                    b.HasOne("MusicСollection.Artist", "Artist")
                        .WithMany("Albums")
                        .HasForeignKey("ArtistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicСollection.Genre", "Genre")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("MusicСollection.Artist", b =>
                {
                    b.HasOne("MusicСollection.Country", "Country")
                        .WithMany("Artists")
            ...
            modelBuilder.Entity("MusicСollection.Playlist", b =>
                {
                    b.HasOne("MusicСollection.Category", "Category")
                        .WithMany("Playlists")
            ...
            modelBuilder.Entity("MusicСollection.Track", b =>
                {
                    b.HasOne("MusicСollection.Playlist", "Playlist")
                        .WithMany("Tracks")
